        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            ...
            <div v-if="isValidating" class="text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400">Verificando enlace...</p>
            </div>
            ...
            <div v-else-if="isValidToken">
             ...
             <div v-else class="text-center">
                ...
                <h2 class="mt-4 text-xl font-bold text-gray-800 dark:text-white">Enlace Inválido</h2>
                <p class="mt-2 text-gray-500 dark:text-gray-400">
                    El enlace ha expirado o es incorrecto.
                </p>
                <router-link
                    :to="{ name: 'ForgotPassword' }"
                    class="mt-6 inline-flex text-brand-500 hover:text-brand-600 font-medium text-sm"
                >
