  ...
  >
    <form @submit.prevent="handleSubmit" class="space-y-6" novalidate>
        ...
        <div class="flex flex-col items-center mb-6">
            ...
            <p v-if="isUploading" class="text-center text-[10px] font-black uppercase tracking-widest text-primary mt-2">Subiendo imagen...</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-xs font-black uppercase tracking-widest text-text-muted mb-1.5">Fecha Próxima Disponibilidad</label>
                <DatePicker 
        ...
        <div>
            ...
            <textarea
                ...
                rows="3"
                class="w-full rounded-lg border border-border bg-surface px-4 py-2.5 text-sm text-text shadow-theme-xs placeholder:text-text-muted/40 focus:border-primary focus:outline-hidden focus:ring-3 focus:ring-primary/10 transition-all font-sans"
            ></textarea>
        </div>
        ...
        <div class="mt-8 flex flex-col-reverse sm:grid sm:grid-cols-2 sm:gap-3">
            <button
                type="button"
                class="mt-3 sm:mt-0 flex items-center justify-center w-full px-4 py-3 text-xs font-black uppercase tracking-widest text-text-muted transition-all bg-surface border border-border rounded-lg hover:bg-surface-muted hover:text-text active:scale-95"
                @click="closeModal"
            >
                Cancelar
            </button>
            <button
                type="submit"
                class="flex items-center justify-center w-full px-4 py-3 text-xs font-black uppercase tracking-widest text-primary-fg transition-all rounded-lg bg-primary shadow-lg shadow-primary/20 hover:bg-primary-hover active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
