  ...
  <AdminLayout>
    <div class="max-w-4xl mx-auto py-10 px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-surface border border-border rounded-[2rem] p-8 shadow-theme-lg">
          <div class="flex items-center gap-3 mb-8">
            <div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary">
              <SunIcon v-if="!themeStore.darkMode" class="w-6 h-6" />
              <MoonIcon v-else class="w-6 h-6" />
            </div>
            <h2 class="text-2xl font-bold text-text">Modo de Apariencia</h2>
          </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div v-if="!themeStore.darkMode" class="absolute -top-2 -right-2 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center">
        ...
        <div class="bg-surface border border-border rounded-[2rem] p-8 shadow-theme-lg">
          <div class="flex items-center gap-3 mb-8">
            ...
            <h2 class="text-2xl font-bold text-text">ADN de Marca</h2>
          </div>
            ...
            <div class="flex flex-col gap-4">
              ...
              >
                <div class="flex items-center gap-4">
                  <div :class="['w-10 h-10 rounded-full shadow-lg transition-transform group-hover:scale-110', color.bgClass]"></div>
                  <span class="font-bold text-text">{{ color.label }}</span>
                </div>
                <div v-if="themeStore.primaryColor === color.id" class="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center translate-x-2">
                  <CheckIcon class="w-4 h-4" />
                </div>
              </button>
            </div>
...
// Palette icon SVG (using settings as fallback or simple custom)
...
<style scoped>
/* Transiciones premium para cambios de color */
