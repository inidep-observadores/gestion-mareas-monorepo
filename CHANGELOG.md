...
### Changed
- **mail:** mejorar precisión del triage procesando el contenido real (texto/imágenes) de los archivos adjuntos en la fase inicial, en lugar de basarse únicamente en los nombres de archivo
