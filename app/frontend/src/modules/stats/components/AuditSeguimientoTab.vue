<template>
   ...
   <div v-else class="divide-y divide-border">
      ...
      <section class="p-5 space-y-4">
         <h3 class="text-[10px] font-black text-text-muted uppercase tracking-widest">Mareas según Estado</h3>
         ...
         <div class="space-y-3 mt-2">
            ...
            <div v-if="specialCases && specialCases.delegadasExternas.length">
               ...
               <p class="text-[9px] font-medium text-amber-700/70 mt-2 px-1 leading-relaxed">
                  La demora en la confección del informe de estas mareas es ajena al Subprograma Observadores a Bordo.
               </p>
            </div>
