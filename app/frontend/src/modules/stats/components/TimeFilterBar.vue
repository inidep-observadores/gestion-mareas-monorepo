<template>
  <div class="bg-surface border border-border rounded-2xl shadow-theme-sm overflow-hidden animate-in fade-in slide-in-from-top-4 duration-500">
    <div class="flex flex-col md:flex-row items-stretch md:items-center">
      
      <!-- Label Section -->
      <div class="px-6 py-4 bg-surface-muted/30 border-b md:border-b-0 md:border-r border-border flex items-center gap-3 shrink-0">
        <div class="p-2 bg-primary/10 rounded-lg text-primary">
          <CalendarIcon class="w-5 h-5" />
        </div>
        <div>
          <span class="text-[10px] font-black text-text-muted uppercase tracking-widest block leading-none">Filtrar por</span>
      ...
      <div class="flex-1 flex flex-wrap items-center gap-4 p-4">
        ...
        <div class="flex-1 flex flex-col gap-1.5 min-w-[280px]">
          <label class="text-[9px] font-black text-text-muted uppercase tracking-widest px-1">Rango Personalizado</label>
