<template>
  <div class="min-h-screen xl:flex bg-primary/5 dark:bg-primary/10 relative overflow-hidden">
    <!-- Distinctive Background Pattern for Observadores -->
    <div class="absolute inset-0 z-0 pointer-events-none opacity-[0.15] dark:opacity-[0.25]">
      <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="observadores-grid" width="40" height="40" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r="1.5" fill="var(--color-primary)" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#observadores-grid)" />
      </svg>
    </div>
