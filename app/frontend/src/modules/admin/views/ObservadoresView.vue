                ...
                <div class="fixed inset-0 overflow-y-auto pointer-events-none">
                    <div class="flex min-h-full items-center justify-center p-4 text-center">
                        <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0 scale-95" 
                            ...
                            <div v-if="showSidePanel && sidePanelObservador !== null" class="w-full max-w-md transform overflow-hidden rounded-2xl bg-surface text-left align-middle shadow-xl transition-all pointer-events-auto flex flex-col max-h-[90vh]">
                                <ObservadorDetailContent
                                    :observador="sidePanelObservador"
                                    @close="closeSidePanel"
                                />
