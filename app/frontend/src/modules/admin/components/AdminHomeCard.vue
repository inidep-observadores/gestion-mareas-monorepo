<template>
  <router-link 
    :to="to"
    class="group relative overflow-hidden bg-surface rounded-3xl border-2 border-border p-6 transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1"
  >
    ...
    <div class="relative z-10 space-y-4">
      ...
      <!-- Content -->
      <div>
        <h3 class="text-lg font-bold text-text group-hover:text-primary transition-colors duration-300">
          {{ title }}
        </h3>
      ...
      <!-- Footer Action -->
      <div class="pt-2 flex items-center text-xs font-bold uppercase tracking-widest text-primary opacity-0 -translate-x-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0">
