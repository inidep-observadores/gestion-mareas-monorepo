...
const export_marea_dto_1 = require("./dto/export-marea.dto");
let MareasController = class MareasController {
    ...
    getDashboardOperativo(year, showAll) {
        return this.mareasService.getDashboardOperativo(year ? Number(year) : undefined, showAll === 'true');
    }
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('showAll')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [export_marea_dto_1.ExportMareaDto, Object]),
    __metadata("design:returntype", Promise)
], MareasController.prototype, "exportExcel", null);
__decorate([
    (0, common_1.Get)(':id'),
