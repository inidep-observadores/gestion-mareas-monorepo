...
exports.MareasModule = MareasModule = __decorate([
    (0, common_1.Module)({
        controllers: [mareas_controller_1.MareasController, tracking_controller_1.TrackingController],
        providers: [mareas_service_1.MareasService, tracking_service_1.TrackingService],
        ...
        exports: [mareas_service_1.MareasService, tracking_service_1.TrackingService],
    })
], MareasModule);
