...
let EspeciesController = class EspeciesController {
    constructor(especiesService) {
        this.especiesService = especiesService;
    }
    crear(createEspecieDto) {
    ...
    actualizar(id, updateEspecieDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [dto_1.CreateEspecieDto]),
    __metadata("design:returntype", void 0)
], EspeciesController.prototype, "crear", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], EspeciesController.prototype, "obtenerTodos", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], EspeciesController.prototype, "obtenerUno", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, decorators_1.Auth)(interfaces_1.ValidRoles.admin),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateEspecieDto]),
    __metadata("design:returntype", void 0)
], EspeciesController.prototype, "actualizar", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], EspeciesController.prototype, "eliminar", null);
exports.EspeciesController = EspeciesController = __decorate([
    (0, common_1.Controller)('catalogos/especies'),
    (0, decorators_1.Auth)(),
