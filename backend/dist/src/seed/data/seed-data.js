    ...
    users: [
        {
            ...
            roles: [interfaces_1.ValidRoles.admin]
        },
        {
            email: 'asistente@google.com',
            fullName: 'Asistente Administrativo',
            password: bcrypt.hashSync('Abc123', 10),
            roles: [interfaces_1.ValidRoles.asistente]
        },
        {
            email: 'tecnico@google.com',
            fullName: 'Técnico de Datos',
            password: bcrypt.hashSync('Abc123', 10),
            roles: [interfaces_1.ValidRoles.tecnico]
        },
        {
            email: 'coordinador@google.com',
            fullName: 'Coordinador General',
            password: bcrypt.hashSync('Abc123', 10),
            roles: [interfaces_1.ValidRoles.coordinador]
        }
    ],
    products: [
        {
