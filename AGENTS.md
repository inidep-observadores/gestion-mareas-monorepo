...
* **Lema:** *"Rigor científico en cada registro."*  
...
* **Estética Visual:**  
  * *Landing/Login:* "Deep Ocean" (Modo oscuro, gradientes marinos profundos, neón cian/azul, efectos SVG).  
  * *Dashboard/Interna:* "Professional Clean" (Modo claro, alta legibilidad, ergonomía de datos, acentos en azul corporativo).
